...
class ProductDownload extends StatefulWidget {
  const ProductDownload({super.key});

  @override
  _ProductDownloadState createState() => _ProductDownloadState();
}

class _ProductDownloadState extends State<ProductDownload> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Downloadរបាយការណ៍លក់', style: GoogleFonts.kantumruyPro(fontSize: 18)),
        centerTitle: true,
        actions: [
          isLoading 
            ? UI.spinKit()
  ...
  void _onDownloadPressed() async {
    String url='share/report/product';
