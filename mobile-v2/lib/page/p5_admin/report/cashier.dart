...
class CashierDownload extends StatefulWidget {
  const CashierDownload({super.key});

  @override
  _CashierDownloadState createState() => _CashierDownloadState();
}

class _CashierDownloadState extends State<CashierDownload> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Download sale report', style: GoogleFonts.kantumruyPro(fontSize: 18)),
        centerTitle: true,
        actions: [
          isLoading 
            ? UI.spinKit()
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              onTap: () {
                setState(() {
                  selectedIndex = index;
                  controller.text = formatDates(title[index], startDate, endDate);
                });
  ...
  void _onDownloadPressed() async {
    String url='share/report/cashier';
